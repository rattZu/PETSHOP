...
<style>
/* Espaço entre a seção de produtos e o carrinho */
.products-container {
  margin-bottom: 200px; /* Adiciona espaço abaixo da lista de produtos */
}
...
.fixed-cart {
  ...
  bottom: 20px;
  right: 20px;
  background-color: #da8f20; /* Cor de fundo */
...
.fixed-cart:hover {
  background-color: rgb(214, 162, 17); /* Cor ao passar o mouse */
}
